				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('position')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="number" class="form-control" placeholder="Posisi" name="position" value="{{ $sub_menu->position }}" >
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea class="form-control" placeholder="Deskripsi" name="desc">{{ $sub_menu->desc }}</textarea>
						</div>
					</div>
