...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/'.Request::segment(1).'/edit/'.$group->id.'/'.$access->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('group_name')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Menu" name="group_name" value="{{ $group->group_name }}" disabled>
						</div>
					</div>
					
					
					<div class="form-group @if ($errors->has('sub_group_name')) has-error @endif">
						<label class="col-sm-2 control-label">{{ __('Nama Sub Menu') }} <span class="required" style="color: #dd4b39;">*</span></label>
						<div class="col-sm-10">
							@if ($errors->has('sub_group_name'))<label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{ $errors->first('sub_group_name') }}</label>@endif
							<input type="text" class="form-control" placeholder="Nama Sub Menu" name="sub_group_name" value="{{ $access->sub_group_name }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('link')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Link" name="link" value="{{ $access->link }}" >
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" placeholder="Atribute" name="attribute" value="{{ $access->attribute }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('position')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="number" class="form-control" placeholder="Posisi" name="position" value="{{ $access->position }}" >
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea class="form-control" placeholder="Deskripsi" name="desc">{{ $access->desc }}</textarea>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('status')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="status">
								...
								<option value="1" @if($access->status=="1") selected @endif>Aktif</option>
								<option value="0" @if($access->status=="0") selected @endif>Tidak Aktif</option>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<a href="{{ url('/'.Request::segment(1).'/'.$group->id) }}" class="btn btn-warning btn-flat btn-sm" title="Kembali">Kembali</a>
						</div>
					</div>
